  ...
  render() {
    return (
        <div id="contact" className="flex flex-col justify-center items-center top-0 h-full w-full gap-6 pointer-events-none mb-96">
            ...
            <a href="https://www.facebook.com/phlawlessDev" className="bg-white w-32 h-32"><img src={'svg/facebook.svg'} alt="facebook logo" /></a>
            <a href="https://www.linkedin.com/in/phlawless-development" className="bg-white w-32 h-32"><img src={'svg/linkedin.svg'} alt ="linkedin logo"/></a>
            <a href="https://github.com/phlawlessDevelopment" className="bg-white w-32 h-32"><img src={'svg/github.svg'} alt="github logo"/></a>
            </div>
