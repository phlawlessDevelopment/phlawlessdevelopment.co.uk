...
class Home extends Component {
  ...
  render() {
    ...
    <img className='-rotate-6 object-contain' src={'stock/stock_6.jpg'}></img>
    </div>
    </div>
    ...
    <div className='flex flex-row justify-center items-center gap-6 w-2/3'>
    <div className='w-2/3 h-auto rotate-6 bg-white' >
    <img className='-rotate-6 object-contain' src={'stock/stock_1.jpg'}></img>
    </div>
            <h1 className="text-md">
    ...
    <div className='w-2/3 h-auto rotate-6 bg-white' >
    <img className='-rotate-6 object-contain' src={'stock/stock_5.jpg'}></img>
    </div>
    </div>
    </div>
